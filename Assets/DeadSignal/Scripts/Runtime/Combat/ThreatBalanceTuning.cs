...
namespace DeadSignal.Combat
{
    ...
    public sealed class ThreatBalanceTuning : ScriptableObject
    {
        ...
        [SerializeField] private float m_wardenSapperScreenDistance = 2.8f;
        [SerializeField] private float m_wardenSapperScreenBreakDistance = 2f;
        ...
        [SerializeField] private float m_deadZoneTraceRecoveryRate = 0.5f;
        ...
        public float WardenSapperScreenDistance => m_wardenSapperScreenDistance;
        public float WardenSapperScreenBreakDistance => m_wardenSapperScreenBreakDistance;
        ...
        public float DeadZoneTraceRecoveryRate => m_deadZoneTraceRecoveryRate;
        ...
        private void OnValidate()
        {
            ...
            m_wardenSapperScreenDistance = Mathf.Max(m_wardenAttackDistance, m_wardenSapperScreenDistance);
            m_wardenSapperScreenBreakDistance = Mathf.Clamp(
                m_wardenSapperScreenBreakDistance, m_wardenAttackDistance, m_wardenSapperScreenDistance);
            ...
            m_deadZoneTraceRecoveryRate = Mathf.Max(0f, m_deadZoneTraceRecoveryRate);
