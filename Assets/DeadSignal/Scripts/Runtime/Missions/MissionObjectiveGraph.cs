    ...
    public static class CompatibilityMissionObjectiveGraph
    {
        public static MissionObjectiveGraph Instance { get; } = new MissionObjectiveGraph(
            ...
            _definition(MissionObjectiveId.FluxShunt, MissionStage.SpinePayload,
                ...
                new[] { MissionObjectiveId.InductionLattice }, new[] { MissionObjectiveId.ConvergenceCalibration }),
            _definition(MissionObjectiveId.ConvergenceCalibration, MissionStage.SpinePayload,
                "Convergence Chamber", "Convergence Calibration Console",
                MissionCompletionRule.ConvergenceCalibrated, MissionWorldMutation.ConvergenceCalibrated,
                Array.Empty<MissionReward>(),
                new MissionGuidanceState(6, "CONVERGENCE FEED ONLINE", "CALIBRATE THE LATTICE IN CONVERGENCE",
                    "HOLD THE CHAMBER  //  MAINTAIN CALIBRATION UNDER PRESSURE"),
                new[] { MissionObjectiveId.FluxShunt }, new[] { MissionObjectiveId.BreakerReset }),
            _definition(MissionObjectiveId.BreakerReset, MissionStage.SpinePayload,
                "Breaker Gallery", "Breaker Distribution Reset",
                MissionCompletionRule.BreakerDistributionReset, MissionWorldMutation.BreakerDistributionReset,
                Array.Empty<MissionReward>(),
            ...
            _definition(MissionObjectiveId.PoweredWithdrawal, MissionStage.Extraction,
                "Relay Foundry / East Transfer Vault / Central Maintenance Concourse / Warden Bay / Sapper Cradle / Departure Channel",
                "Powered Withdrawal Pursuit Route",
                MissionCompletionRule.PoweredWithdrawalComplete, MissionWorldMutation.PoweredWithdrawalComplete,
                Array.Empty<MissionReward>(),
                new MissionGuidanceState(7, "WITHDRAW THROUGH POWER", "FOLLOW THE CYAN RETURN TO THE DEPARTURE CHANNEL",
                    "OPEN SHORTCUTS + PURSUIT + ONE-SHOT SURGE  //  DOCK UPLINK FOLLOWS"),
