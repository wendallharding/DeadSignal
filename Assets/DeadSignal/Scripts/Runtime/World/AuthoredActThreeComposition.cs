...
{
    /// <summary>Marks the non-colliding authored structure that visually unifies the Act III deep-core rooms.</summary>
    public sealed class AuthoredActThreeComposition : MonoBehaviour
    {
