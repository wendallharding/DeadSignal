    ...
    public sealed class BootstrapSmokeTests
    {
        ...
        public IEnumerator RelayFoundry_ActivatesSecondFootholdAndReturnShortcut()
        {
            ...
            try
            {
                ...
                Assert.That(Resources.Load<Texture2D>("Environment/SpineHeroAtlas"), Is.Not.Null);
                Assert.That(Resources.Load<Mesh>("Environment/CapacitorSpineHeroFinish"), Is.Not.Null);
                Assert.That(Resources.Load<Mesh>("Environment/DischargeTrenchHeroFinish"), Is.Not.Null);
                Assert.That(Resources.Load<Texture2D>("Environment/InductionFluxHeroAtlas"), Is.Not.Null);
                Assert.That(Resources.Load<Mesh>("Environment/InductionGalleryHeroFinish"), Is.Not.Null);
                Assert.That(Resources.Load<Mesh>("Environment/FluxBypassHeroFinish"), Is.Not.Null);
                Assert.That(Resources.Load<Texture2D>("Environment/ConvergenceBreakerHeroAtlas"), Is.Not.Null);
                Assert.That(Resources.Load<Mesh>("Environment/ConvergenceChamberHeroFinish"), Is.Not.Null);
                Assert.That(Resources.Load<Mesh>("Environment/BreakerGalleryHeroFinish"), Is.Not.Null);
        ...
        public IEnumerator SceneLoad_BootstrapsCompleteRuntimeWithoutErrors()
        {
            ...
            Assert.That(Object.FindFirstObjectByType<ExtractionOutcomeFeedbackController>(), Is.Not.Null,
                "Reflex composition should provide one fixed-owner extraction/outcome presenter.");
            Assert.That(game.HasExtractionOutcomeFeedbackTexture, Is.True,
                "The extraction/outcome presenter should reuse the authored transparent station glyph.");
            Assert.That(game.ExtractionOutcomeFeedbackPoolSize, Is.EqualTo(2));
