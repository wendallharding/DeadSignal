...
- [x] **Presentation Run P17 — Act I branch lighting:** give Cargo, Coolant, Relay Fork, and Transfer Vault distinct but coherent lighting identities that support their verbs, mark return direction, and keep enemies/projectiles readable without flattening the station
- [x] **Presentation Run P18 — Relay-region lighting:** refine Foundry and Gantry dormant/powered contrast, turbine-lane readability, gate warnings, weapon-calibration focus, and return-route cyan without obscuring magenta/red enemy effects
- [x] **Presentation Run P19 — Spine-region lighting:** refine transfer-bank silhouette, protected/exposed lane contrast, pressure warning, vent transition, tower activation, and powered-return lighting across Spine and Trench while protecting projectile visibility
- [x] **Presentation Run P20 — Deep-core lighting:** create a controlled progression from dead-zone Induction/Flux through Convergence/Breaker to Furnace/Quench using local task light, restrained heat/coolant contrast, and persistent return cues; preserve darkness as mood rather than navigation ambiguity
