...
`create_bypass_marker.py` builds the broad double-chevron floor marker used to identify the bay-to-annex route, exports its Unity-oriented FBX, saves the editable Blender source, and renders a review preview.
...
The route marker is a purpose-built, beveled XZ-floor mesh that reuses the game's cyan navigation material and has no gameplay collider.
