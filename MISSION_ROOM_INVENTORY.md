...
5. Continue east to the Capacitor Spine; no Foundry sibling cache bypass remains.
6. Activate Spine Tower and choose the auxiliary evolution.
7. Collect exactly one Spine payload from the hard-coded north/south sockets within Capacitor Spine.
